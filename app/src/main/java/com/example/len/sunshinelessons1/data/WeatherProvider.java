...
//            case WEATHER_WITH_LOCATION:
    ...
    public int update(
        ...
        switch (match){
            case WEATHER:
                normalizeDate(values);
                rowsUpdate = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            case LOCATION:
                rowsUpdate = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown Uri: " + uri);
