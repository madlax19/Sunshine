...
import com.example.len.sunshinelessons1.data.WeatherContract.LocationEntry;
import com.example.len.sunshinelessons1.data.WeatherContract.WeatherEntry;
   ...
   public void testGetType() {
    ...
    public void testInsertReadProvider() {
       ...
       // Register a content observer for our insert.  This time, directly with the content resolver
        TestUtilities.TestContentObserver tco = TestUtilities.getTestContentObserver();        mContext.getContentResolver().registerContentObserver(LocationEntry.CONTENT_URI, true, tco);
